...
> = {
  google: {
    ...
    authMethod: "oauth",
    emailConnectorEnv: "VERCEL_CONNECT_GOOGLE_CONNECTOR",
    calendarConnectorEnv: "VERCEL_CONNECT_GOOGLE_CONNECTOR",
  },
  microsoft: {
    label: "Microsoft",
    services: ["email", "calendar"],
    authMethod: "oauth",
    emailConnectorEnv: "VERCEL_CONNECT_MICROSOFT_CONNECTOR",
    calendarConnectorEnv: "VERCEL_CONNECT_MICROSOFT_CONNECTOR",
  },
  yahoo: {
    label: "Yahoo",
    services: ["email"],
    authMethod: "oauth",
    emailConnectorEnv: "VERCEL_CONNECT_YAHOO_CONNECTOR",
  },
  icloud: {
    label: "iCloud Mail",
    services: ["email"],
